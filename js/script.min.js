...
if (mq_mobile.matches) {
    ...
    console.log("tablet");
    memory_array = [ "A", "A", "B", "B", "C", "C", "D", "D", "E", "E", "F", "F", "G", "G", "H", "H", "I", "I", "J", "J", "K", "K", "L", "L", "M", "M", "N", "N", "O", "O", "P", "P", "Q", "Q", "R", "R" ];
} else if (mq_desktop.matches) {
    console.log("desktop");
    memory_array = [ "A", "A", "B", "B", "C", "C", "D", "D", "E", "E", "F", "F", "G", "G", "H", "H", "I", "I", "J", "J", "K", "K", "L", "L", "M", "M", "N", "N", "O", "O", "P", "P", "Q", "Q", "R", "R", "S", "S", "T", "T" ];
}
...
Array.prototype.memory_tile_shuffle = function() {
    //lägg till en shuffle method till array objektet via prototype
    ...
    if (tile.innerHTML == "" && memory_values.length < 2) {
        ...
        if (memory_values.length == 0) {
            ...
            if (memory_values[0] == memory_values[1]) {
                ...
                //Om brickornas värde inte stämde
                function flip2back() {
                    ...
                    tile_2.innerHTML = "";
                    if (points > 0) {
                        //om poängen redan är på 0 kan man inte förlora poäng.
                        points -= 2;
                        localStorage.setItem("points", points);
                    }
                    displayPoints();
